...
function createDayChoropleths(mapData, bikeData,i) {


            d3.select("#day-start-map").select("svg").remove();
            d3.select("#day-end-map").select("svg").remove();
            ...
            startMap.selectAll(".district")
                .style("fill", d => dayColor(startCounts.get(i).get(+d.properties.communityDistrict) || 0))
                .select("title").text(d => startCounts.get(i).get(+d.properties.communityDistrict));
            endMap.selectAll(".district")
                .style("fill", d => dayColor(endCounts.get(i).get(+d.properties.communityDistrict) || 0))
                .select("title").text(d => endCounts.get(i).get(+d.properties.communityDistrict));
...
function createVis(data) {
    ...
    var i = document.getElementById("ranges").value;
    createDayChoropleths(mapData, bikeData,i);
